...
class WordTrigger(Trigger):
    ...
    def isWordIn(self, text):
        def puncToSpace(text):
            """
            Converts any punctuation in text to a space character.
            
            text: string | The string to convert.
            return: string | text with all punctuation converted to spaces.
            """
            result = ''
        ...
        wordSet = puncToSpace(text.lower()).split(' ')

        return self.word in wordSet
...
class PhraseTrigger(Trigger):
    ...
    def evaluate(self, story):
        return (self.word in story.getTitle() or
                self.word in story.getSubject() or
                self.word in story.getSummary())
